export function EndBanner() {
  return (
    <section id="end-banner" className="d-flex justify-content-center align-items-center text-center py-2">
      <svg id="emoji" xmlns="http://www.w3.org/2000/svg" width="15%" height="auto" fill="#0d6efd"
